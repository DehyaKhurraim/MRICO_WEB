...
class Locations extends StatelessWidget {
  Color? col;
  String? title;
  Locations({Key? key, required col, required title})
      : super(
          key: key,
        );
  ...
  Widget build(BuildContext context) {
    return Container(
        margin: const EdgeInsets.symmetric(vertical: 16.0, horizontal: 50.0),
          ...
          children: [
            RichText(
              text: TextSpan(
                ...
                children: [
                  TextSpan(text: 'Most Popular Locations for $title\n'),
                ],
              ),
            ),
            SizedBox(
